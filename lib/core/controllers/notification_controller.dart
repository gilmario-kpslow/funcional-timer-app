...
import 'package:cristimer/main.dart';
...
class NotificationController {
  ...
  static Future<void> onActionReceivedImplementationMethod(
      ReceivedAction receivedAction) async {
    FuncinalApp.navigatorKey.currentState?.pushNamedAndRemoveUntil(
        '/notification-page',
        (route) =>
  ...
  static Future<bool> displayNotificationRationale() async {
    ...
    BuildContext context = FuncinalApp.navigatorKey.currentContext!;
    await showDialog(
        context: context,
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const Text('Autorizar notificações!'),
              ],
            ),
            actions: [
              TextButton(
  ...
  static Future<void> createNewNotification() async {
    ...
    await AwesomeNotifications().createNotification(
      ...
      content: NotificationContent(
        ...
        // chronometer: Duration(seconds: 10),
